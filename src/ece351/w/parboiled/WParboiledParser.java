...
//throw new ece351.util.Todo351Exception();
		// [WProgram]
		return Sequence(push(new WProgram ()),OneOrMore(Waveform()), W0(),EOI);
    }
...
//throw new ece351.util.Todo351Exception();
    	// [Waveform, [WPogram]]
    	// swap : [[WProgram],Waveform]
    	// merge: [[Wprogram, Waveform]
    	return Sequence(Name(), push(new Waveform(match())),W0(), ":",W0(), BitString(),W0(),";",W0(), swap(),push(((WProgram)pop()).append((Waveform) pop())));
    }
...
// TODO: short code snippet
//throw new ece351.util.Todo351Exception();
    	return Sequence(Letter(),ZeroOrMore(FirstOf(Letter(), CharRange('0', '9'))));
    }

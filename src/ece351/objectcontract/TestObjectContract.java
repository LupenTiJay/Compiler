...
//throw new ece351.util.Todo351Exception();
	...
	SymmetryBreaker[] constructSymmetryBreakers() {
		...
		SymmetryBreaker obj1 = new SymmetryBreaker(1, null);
		SymmetryBreaker obj2 = new SymmetryBreaker(1, obj1);
		
//		if (result[0].equals(result[1]) && result[1].equals(result[0])){
//			return result;
//		}
		
//		boolean val = obj1.equals(obj2);
//		val = obj2.equals(obj1);
...
//throw new ece351.util.Todo351Exception();
	...
	TransitivityBreaker[] constructTransitivityBreakers() {
		...
		TransitivityBreaker a = new TransitivityBreaker(epsilon6);
		TransitivityBreaker b = new TransitivityBreaker(2 * epsilon6);
		TransitivityBreaker c = new TransitivityBreaker(3 * epsilon6);
...
//throw new ece351.util.Todo351Exception();
	...
	Object[] constructHashcodeConsistencyViolators() {
		...
		result[0] = constructAlwaysTrue(); // return object
